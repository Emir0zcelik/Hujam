	...
	SubShader {
		...
		Pass {
			...
			float4 frag (GeometryOutput input, bool isFrontFace : SV_IsFrontFace) : SV_Target {
				...
				return lerp(_Color, _Color2, input.uv.y * _LerpMultiplier) * float4(shading, 1);
			}
